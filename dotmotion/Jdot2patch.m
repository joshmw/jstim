...
% task parameters
task{1}.segmin = [.5 1 inf 1]; task{1}.segmax = [.5 1 inf 1]; task{1}.getResponse = [0 0 1 0];
task{1}.numTrials = 500; task{1}.randVars.calculated.confidence = nan;
...
stimulus.numStim = 2 %number of stimuli you want to draw
task{1}.random=0;


% Estimate: Set what parameter you want to estimate %
stimulus.estimateSpeed = 1;
stimulus.estimateDirection = 0;


% Set stimulus values %
stimulus.Ecc1 = 8;
stimulus.Ecc2 = -8;
stimulus.width = 6; %stimuli and response
stimulus.speed = 4; %initial response speed
stimulus.contrast = .8; %stimuli and response
stimulus.density = 2; %stimuli and response


% Stimuli motion components
task{1}.parameter.dir1 = [140];
task{1}.parameter.coherence1 = [.6];
